...
var levels_data : Array = [
	...
	["res://levels/GameLevels/World01/W01L08.tscn", 0, 10, false, true, 0.0, false, 0, 0.0],
	["res://levels/GameLevels/World01/W01L09.tscn", 0, 10, false, true, 0.0, false, 0, 0.0],
	["res://levels/GameLevels/World01/W01L10.tscn", 0, 10, false, true, 0.0, false, 0, 0.0],
	["res://levels/GameLevels/World01/W01L11.tscn", 0, 10, false, true, 0.0, false, 0, 0.0],
	["res://levels/GameLevels/World01/W01L12.tscn", 0, 10, false, true, 0.0, false, 0, 0.0],
...
func update_level_data() -> void:
	...
	if get_level_time(current_level_id) < level_time and GameManager.is_difficulty_normal():
		set_level_time(current_level_id, level_time)
	
	
	if get_level_time_hard(current_level_id) < level_time and GameManager.is_difficulty_hard():
		set_level_time_hard(current_level_id, level_time)
...
func set_level_time_hard(level_id: int, time: float) -> void:
	levels_data[level_id][8] = time


func get_level_time_hard(level_id: int) -> float:
	return levels_data[level_id][8]
